...
export const expertsData: ExpertData[] = [
  ...
  },
  {
    ...
    fullBio: "從電機工程博士到創業實踐者，Aaron擅長將複雜技術轉化為實用系統。他不僅具備深厚的技術底蘊，更擁有跨領域整合與團隊領導的實戰經驗。相信「理解比記憶重要，邏輯比資料長久」，善於用第一性原理解決複雜問題。現為Procus創辦人，致力於協助專業者打造個人品牌，讓有能力但尚未被看見的人用自己的方式發光。",
